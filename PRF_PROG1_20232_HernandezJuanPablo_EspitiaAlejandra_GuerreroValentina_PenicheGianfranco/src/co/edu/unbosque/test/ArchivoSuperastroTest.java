...
/**
 * Clase de prueba JUnit para la clase ArchivoSuperastro.
 */
public class ArchivoSuperastroTest {

    // La instancia de la clase ArchivoSuperastro que se va a probar
    static ArchivoSuperastro archivoSuperastro;

    // Contador para el número de prueba
    static int testNumber = 1;

    /**
     * Método que se ejecuta una vez antes de todas las pruebas. Inicializa la instancia de ArchivoSuperastro.
     */
    @BeforeClass
    public static void beforeAll() {
        System.out.println("Iniciando pruebas unitarias para ArchivoSuperastro");
    ...
    /**
     * Caso de prueba para verificar la creación del archivo de apuestas Superastro.
     */
    @Test
    public void testCrearArchivo() {
        System.out.println("Empezando la prueba crearArchivo");
        archivoSuperastro.crearArchivo();
        assertTrue(archivoSuperastro.getFileApuesta().exists());
    }

    /**
     * Caso de prueba para verificar la escritura del archivo de apuestas Superastro.
     */
    @Test
    public void testEscribirArchivo() {
        System.out.println("Empezando la prueba escribirArchivo");
        ArrayList<ApuestaSuperastroDTO> apuestasSuperastro = new ArrayList<>();
        archivoSuperastro.escribirArchivo(apuestasSuperastro);
        // Agrega aserciones según sea necesario
    }

    /**
     * Caso de prueba para verificar la inicialización del archivo de apuestas Superastro.
     */
    @Test
    public void testInicializarArchivo() {
        System.out.println("Empezando la prueba inicializarArchivo");
        ArrayList<ApuestaSuperastroDTO> result = archivoSuperastro.inicializarArchivo();
    ...
    public static void afterAll() {
        System.out.println("Finalizando pruebas para ArchivoSuperastro");
    }
}

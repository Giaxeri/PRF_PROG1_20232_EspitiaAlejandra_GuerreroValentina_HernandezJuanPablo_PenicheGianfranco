...
public class VentanaBaloto extends JFrame {
	...
	/**
	 * La clase VentanaBaloto representa la interfaz gráfica para el juego de
	 * Baloto.
	 */
	private static final long serialVersionUID = 1L;
	private JLabel fondo;
	private TextField pDiaApuesta, pValorApuesta, pNumeroApostado;
	private JLabel diaApuestaTxt, valorApuestaTxt, numeroApostadoTxt;
	private JButton botonApostar, botonModificar, botonEliminar, flecha;

	/**
	 * Constructor de la clase VentanaBaloto. Inicializa y configura la interfaz
	 * gráfica.
	 */
	...
	public VentanaBaloto() {
		...
		numeroApostadoTxt.setBounds(40, 470, 600, 25);
		numeroApostadoTxt
				.setText("Inserte el número al cual quiere apostar (Ingreselo con espacios, de la forma 1 2 3 4 5 6)");
